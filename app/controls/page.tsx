...
export default function Controls() {
  ...
  const [isWarmUpClicked, setIsWarmUpClicked] = useState(false);

  const handleClick = () => {
    alert("Button clicked!");
    setIsWarmUpClicked(true); // Enable SlideButton when clicked
  };
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 text-center mr-32 ml-32">
          ...
          <div className="flex flex-col items-center p-4 md:p-6 rounded-lg shadow-md w-full sm:w-auto text-center">
            <div className="flex items-center">
              ...
              <SlideButton disabled={!isWarmUpClicked} /> {/* Disable SlideButton if not clicked */}
